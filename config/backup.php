...
return [
   ...
   'cleanup' => [
    ...
    'default_strategy' => [
        'keep_all_backups_for_days' => 7,      // Mantiene todos por una semana (útil en desarrollo)
        'keep_daily_backups_for_days' => 30,   // Luego mantiene 1 diario por 30 días
        'keep_weekly_backups_for_weeks' => 4,  // Luego mantiene 1 semanal por 4 semanas
        'keep_monthly_backups_for_months' => 2, // Finalmente mantiene 1 mensual por 2 meses
        'keep_yearly_backups_for_years' => 0,   // No aplica aún
